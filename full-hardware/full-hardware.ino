...
class CharacteristicCallbacks : public NimBLECharacteristicCallbacks
{
  ...
  void onWrite(NimBLECharacteristic *pCharacteristic)
  {
    ...
    else if (msgType == "S")
    {
      ...
      String str_jwt = characteristicMsg.substring(firstSpaceInd+1);
      packetjwt += str_jwt;
      return;
    ...
    else if (msgType == "F")
    {
      ...
      // http.begin(client, "http://ec2-54-177-39-50.us-west-1.compute.amazonaws.com:3000/verify");
      // int httpResponseCode = http.POST(packetjwt);
...
void lockDoor()
{
  Serial.println(F("Door in locked state!"));
  myservo.write(180);
}

void unlockDoor()
{
  Serial.println(F("Door in unlocked state!"));
  myservo.write(0);
}
...
// WIFI SETUP
  ...
  Serial.println(F("Lock initially set to"));
